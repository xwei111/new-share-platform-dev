...
@cardable(['门店核销量查询'])
@queriable({url: `${host}/cp/coupon/query!queryActiveUsedBySummary.action`, formatData, formatTotal, formatDate: true})
export default class ProductSale extends Component {
  render() {
    return (
      <QueryTable
        {...this.props}
        exportUrl={`${host}/cp/coupon/query!exportActiveUsedBySummary.action`}
