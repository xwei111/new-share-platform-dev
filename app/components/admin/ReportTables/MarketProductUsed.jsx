...
@cardable(['门店单品核销量查询'])
@queriable({url: `${host}/cp/coupon/query!queryActiveUsedByMarket.action`, formatData, formatTotal, formatDate: true})
export default class MarketProductUsed extends Component {
  render() {
    return (
      <QueryTable
        {...this.props}
        exportUrl={`${host}/cp/coupon/query!exportActiveUsedByMarket.action`}
