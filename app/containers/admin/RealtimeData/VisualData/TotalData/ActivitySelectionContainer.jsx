...
@connect(({visualdata}) => ({
    ...
    endtime: visualdata.endtime}), dispatch => bindActionCreators(visualdataActionCreators, dispatch))
...
export default class ActivitySelectionContainer extends React.Component {
    ...
    handleSubmit() {
        const {activeid, activename, starttime, endtime, form, trendKey} = this.props;
